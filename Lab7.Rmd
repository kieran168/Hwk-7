...
```{r Question 2 Subgroups and Logit, eval=FALSE, include=FALSE}
...
names(dat_for_analysis_sub) <- c("NOTCOV",
                                 ...
                                 "born.unknown")
```
We've utilized the provided data.frame and standarizing code to standardize the variables and create our training and test sets. The training set is comprised of 75% of the observations.    
```{r Standardize for Sobj, include=FALSE}
require("standardize")
set.seed(654321)
NN <- length(dat_for_analysis_sub$NOTCOV)
NN
restrict_1 <- as.logical(runif(NN) < 0.75) # use fraction as training data
# summary(restrict_1)
