...
print(model1_ridge)
vip(model1_ridge, num_features = 50, geom = "point")
#https://bradleyboehmke.github.io/HOML/regularized-regression.html

cvmodel1_ridge = cv.glmnet(data.matrix(sobj$data[,-1]),data.matrix(sobj$data$NOTCOV)) 
cvmodel1_ridge$lambda.min
log(cvmodel1_ridge$lambda.min)
coef(cvmodel1_ridge, s = "lambda.min")

pred1_ridge <- predict(model1_elasticnet, newx = data.matrix(s_dat_test), s = cvmodel1_ridge$lambda.min)
...
print(model1_lasso)
vip(model1_lasso, num_features = 50, geom = "point")
#https://bradleyboehmke.github.io/HOML/regularized-regression.html
...
vip(cvmodel1_lasso, num_features = 50, geom = "point")

pred1_lasso <- predict(model1_elasticnet, newx = data.matrix(s_dat_test), s = cvmodel1_lasso$lambda.min)
